...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SPO2_progress_bar = QtWidgets.QProgressBar(self.statusbar_frame)
        self.SPO2_progress_bar.setGeometry(QtCore.QRect(20, 20, 21, 91))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.SPO2_progress_bar.setFont(font)
        self.SPO2_progress_bar.setStyleSheet("selection-background-color: rgb(255, 255, 0);\n"
"gridline-color: rgb(255, 255, 0);\n"
"")
        self.SPO2_progress_bar.setProperty("value", 24)
        self.SPO2_progress_bar.setAlignment(QtCore.Qt.AlignCenter)
        self.SPO2_progress_bar.setOrientation(QtCore.Qt.Vertical)
        self.SPO2_progress_bar.setInvertedAppearance(False)
        self.SPO2_progress_bar.setObjectName("SPO2_progress_bar")
        ...
        self.FreezeDisplay_Button = QtWidgets.QPushButton(self.footer_frame_2)
        self.FreezeDisplay_Button.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.FreezeDisplay_Button.setObjectName("FreezeDisplay_Button")
        self.verticalLayout_3.addWidget(self.FreezeDisplay_Button)
...
"gridline-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FreezeDisplay_Button.setText(_translate("MainWindow", "Frezze Display"))
        self.pushButton_2.setText(_translate("MainWindow", "Capture"))
        self.pushButton_3.setText(_translate("MainWindow", "Print Screenshot"))
